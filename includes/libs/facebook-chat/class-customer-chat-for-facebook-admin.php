...
class Customer_Chat_Admin {
	...
	public function Customer_Chat_admin_menu() {
		add_submenu_page( 'ca-mobile-elements', 'Customer Chat for Facebook', 'Customer Chat for Facebook', 'manage_options', $this->Customer_Chat , array($this, 'display_plugin_admin_page') );
	...
	public function display_plugin_admin_page(){
		require_once  'customer-chat-for-facebook-admin-display.php';
	}
      ...
      // If the Facebook Page ID is not set and we are not on the settings page
		    ...
		    ?>
				    <div class="notice notice-error">
				        <p>Serpwars Customer Chat for Facebook needs to be setup. <a href="<?php echo $site_url; ?>/wp-admin/admin.php?page=serpwars-customer-chat-for-facebook">Setup</a></p>
				    </div>
		    <?php
			}
	}
