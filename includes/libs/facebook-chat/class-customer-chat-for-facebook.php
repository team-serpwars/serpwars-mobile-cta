...
class Customer_Chat {
	...
	public function __construct() {
		...
		$this->Customer_Chat = 'serpwars-customer-chat-for-facebook';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once 'class-customer-chat-for-facebook-loader.php';
		 ...
		 */
		require_once  'class-customer-chat-for-facebook-admin.php';

		/**
		 * The class responsible for defining all Settings.
		 */
		require_once 'class-customer-chat-for-facebook-settings.php';
		 ...
		 * side of the site.
		 */
		// require_once 'public/class-customer-chat-for-facebook-public.php';
