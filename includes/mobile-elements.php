...
class CA_Mobile_Elements_Admin{
	...
	public function load_assets($hook){
		...
		if($hook=='mobile-cta_page_ca_add_new_mobile_cta'){	
			...
			wp_enqueue_style( "new-serp-app", CA_MOBILE_ELEMENTS_ASSETS. '/css/app.ab86b485.css', array(),"1.0.0", 'all' );
			global $post;

			$id = (isset($_GET["id"])) ?  $_GET["id"] : 0;
			wp_enqueue_script( "serp-vendor-new-js", CA_MOBILE_ELEMENTS_ASSETS . '/js/chunk-vendors.61e59e7d.js', array(), "1.0.4", true );
			wp_enqueue_script( "serp-app-new-js", CA_MOBILE_ELEMENTS_ASSETS . '/js/app.a6b57673.js', array(), "1.0.0", true );
