...
class SERPWARS_Mobile_Elements_Admin{
	...
	public function load_assets($hook){
		...
		if($hook=='mobile-cta_page_ca_add_new_mobile_cta'){	
			wp_enqueue_style( "new-serp-vendor", SERPWARS_MOBILE_ELEMENTS_ASSETS. '/css/chunk-vendors.516dab1a.css', array(),"1.0.0", 'all' );
			...
			wp_enqueue_script( "serp-vendor-new-js", SERPWARS_MOBILE_ELEMENTS_ASSETS . '/js/chunk-vendors.bc5dd6a5.js', array(), "1.0.5", true );
			// wp_deregister_script('jquery');
			// wp_enqueue_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js', array(), null, true);
			wp_enqueue_script( "serp-app-new-js", SERPWARS_MOBILE_ELEMENTS_ASSETS . '/js/app.bc3cad11.js', array(), "1.0.0", true );
